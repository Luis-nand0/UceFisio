  ...
  const exercise = {
    ...
    steps: [
      { 
        id: 1, 
        title: "Segunda-Feira", 
        titleDesc: "Amplitude de Movimento", 
        desc: "Treino para mobilidade e a flexibilidade das articulações e tecidos moles (músculos e tendões)." 
    },
      { 
        id: 2, 
        title: "Terça-Feira", 
        titleDesc: "Extensão da coluna", 
        desc: "Exercício focado na correção da postura, restaurar a curvatura natural e aliviar dores nas costas." 
      },
      { 
        id: 3, 
        title: "Quarta-Feira",
            ...
            <View key={step.id} style={[styles.accordionItem, isExpanded && styles.accordionItemActive]}>
              ...
              {isExpanded && (
                <View style={styles.stepContent}>
                  ...
                  <Text style={styles.stepDesc}>{step.titleDesc}</Text>
